...
print("compiling cuda source of 'pair_wise_distance' function...")
...
class PairwiseDistFunction(torch.autograd.Function):
    @staticmethod
    def forward(self, pixel_features, deep_feature, sdf_feature, spixel_features, init_spixel_indices, num_spixels_width, num_spixels_height):
        ...
        self.save_for_backward(pixel_features, deep_feature, sdf_feature, spixel_features, init_spixel_indices)

        return pair_wise_distance_cuda.forward(
            pixel_features.contiguous(), deep_feature.contiguous(), sdf_feature.contiguous(), spixel_features.contiguous(),
    ...
    def backward(self, dist_matrix_grad):
        pixel_features, deep_feature, sdf_feature, spixel_features, init_spixel_indices = self.saved_tensors
        ...
        pixel_features_grad, spixel_features_grad = pair_wise_distance_cuda.backward(
            ...
            deep_feature.contiguous(), sdf_feature.contiguous(),
            spixel_features.contiguous(), init_spixel_indices.contiguous(),
            pixel_features_grad, spixel_features_grad,
            self.num_spixels_width, self.num_spixels_height
        )
        return pixel_features_grad, None, None, spixel_features_grad, None, None, None
